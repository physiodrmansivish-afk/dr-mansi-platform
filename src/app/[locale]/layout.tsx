...
export default async function LocaleLayout({
  ...
  const jsonLd = {
    ...
    description: 'Expert physiotherapy care at your doorstep across Diva, Dombivli, Kalyan, Thane, Vikhroli & Mumbai. Personalized orthopedic rehabilitation, post-surgery recovery, and pain management by Dr. Mansi Vishwakarma (BPT, MPT Ortho).',
    address: {
      '@type': 'PostalAddress',
    ...
    areaServed: [
      ...
      { '@type': 'Neighborhood', name: 'Diva' },
      { '@type': 'Neighborhood', name: 'Diva East' },
      { '@type': 'Neighborhood', name: 'Kopar' },
      { '@type': 'Neighborhood', name: 'Thakurli' },
      { '@type': 'Neighborhood', name: 'Vithalwadi' },
      ...
      { '@type': 'Neighborhood', name: 'Kalwa' },
      { '@type': 'Neighborhood', name: 'Mulund' },
      { '@type': 'Neighborhood', name: 'Nahur' },
      { '@type': 'Neighborhood', name: 'Bhandup' },
      { '@type': 'Neighborhood', name: 'Kanjurmarg' },
